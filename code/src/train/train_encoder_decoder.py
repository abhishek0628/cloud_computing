...
def train_reinforce(
    ...
    SAVE_DIR = os.path.join(os.path.abspath(os.path.join(SRC_DIR, "..")), "experiments")
    os.makedirs(SAVE_DIR, exist_ok=True)
    SAVE_PATH = os.path.join(SAVE_DIR, "encoder_decoder.pth")
    ...
    # Save training loss
    np.save(os.path.join(SAVE_DIR, "training_loss.npy"), np.array(training_loss))
    print(f"\nTraining complete. Saved to {SAVE_PATH}")
